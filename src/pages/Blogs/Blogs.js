...
const Blogs = () => {
    return (
        <div className='container mx-auto'>
            <div>
                <h1 className="font-bold text-4xl text-success my-8">Question 1: What are the different ways to manage a state in a React application?</h1>
                <div >
                    <p className='p-8'>Once you attempt to manage state across multiple components, things get a bit trickier.
            ...
            <div>
                <h1 className="font-bold text-4xl text-success my-4">Question 2: What is a unit test? Why should we write unit tests?</h1>
                <div className='p-8'>
                    <h3 className='text-3xl font-semibold text-warning my-2'>What is a unit test?</h3>
                    ...
                    <h3 className='text-3xl font-semibold text-warning my-2'>Why should we write unit tests?</h3>
            ...
            <div>
                <h1 className="font-bold text-4xl text-success my-3">Question 3: How does prototypical inheritance work?</h1>
            ...
            <div className='mb-10'>
                <h1 className="font-bold text-4xl text-success my-4">Question 4: React vs. Angular vs. Vue? What are the difference among them?</h1>
                <div className='p-8'>
                    <h3 className='text-3xl font-semibold text-warning my-2'>React</h3>
                    <p>It's used for building interactive user interfaces and web applications quickly and efficiently with significantly less code than you would with vanilla JavaScript. In React, you develop your applications by creating reusable components that you can think of as independent Lego blocks.</p>
                    <h3 className='text-3xl font-semibold text-warning my-2'>Angular</h3>
